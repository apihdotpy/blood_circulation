...
export default function DescriptionBottom({ topFocus, bottomFocus }) {
  const topDescription =
    'Bunyi "lub" dihasilkan apabila injap trikuspid dan injap bikuspid tertutup.';
  const bottomDescription =
    'Bunyi pertama "lub" dihasilkan apabila injap trikuspid dan injap bikuspid tertutup.';
  return (
    <div className="flex justify-center">
      <div className="flex">
        <div className="flex bg-yellow-100 pb-4 px-4 rounded-lg tracking-wide animate__animated animate__backInUp">
